...
#define SSTATUS_UIE         0x00000001 // 用户模式中断使能
#define SSTATUS_SIE         0x00000002 // 超级用户模式中断使能
#define SSTATUS_UPIE        0x00000010 // 用户模式中断使能前的状态
#define SSTATUS_SPIE        0x00000020 // 超级用户模式中断使能前的状态
#define SSTATUS_SPP         0x00000100 // 超级用户模式优先级
#define SSTATUS_FS          0x00006000 // 浮点状态
#define SSTATUS_XS          0x00018000 // 扩展状态
#define SSTATUS_SUM         0x00040000 // 超级用户模式下的用户内存访问
#define SSTATUS_MXR         0x00080000 // 修改权限
#define SSTATUS32_SD        0x80000000 // 32位超级用户模式状态
#define SSTATUS_UXL         0x0000000300000000 // 用户模式XLEN
#define SSTATUS64_SD        0x8000000000000000 // 64位超级用户模式状态
