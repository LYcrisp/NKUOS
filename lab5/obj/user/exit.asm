...
main(void) {
  ...
  80057c:	c579                	beqz	a0,80064a <main+0xe4>
  ...
  80058a:	b91ff0ef          	jal	ra,80011a <cprintf>
    ...
    assert(pid > 0);
  80058e:	08805e63          	blez	s0,80062a <main+0xc4>
  ...
  8005be:	c531                	beqz	a0,80060a <main+0xa4>
  8005c0:	b11ff0ef          	jal	ra,8000d0 <wait>
  8005c4:	c139                	beqz	a0,80060a <main+0xa4>
  ...
  8005fa:	02400593          	li	a1,36
  8005fe:	00000517          	auipc	a0,0x0
  800602:	45a50513          	addi	a0,a0,1114 # 800a58 <error_string+0x150>
  800606:	a1bff0ef          	jal	ra,800020 <__panic>
    assert(waitpid(pid, &code) != 0 && wait() != 0);
  80060a:	00000697          	auipc	a3,0x0
  80060e:	4ae68693          	addi	a3,a3,1198 # 800ab8 <error_string+0x1b0>
  800612:	00000617          	auipc	a2,0x0
  800616:	42e60613          	addi	a2,a2,1070 # 800a40 <error_string+0x138>
  80061a:	02500593          	li	a1,37
  80061e:	00000517          	auipc	a0,0x0
  800622:	43a50513          	addi	a0,a0,1082 # 800a58 <error_string+0x150>
  800626:	9fbff0ef          	jal	ra,800020 <__panic>
    assert(pid > 0);
  80062a:	00000697          	auipc	a3,0x0
  80062e:	40e68693          	addi	a3,a3,1038 # 800a38 <error_string+0x130>
  800632:	00000617          	auipc	a2,0x0
  800636:	40e60613          	addi	a2,a2,1038 # 800a40 <error_string+0x138>
  80063a:	02100593          	li	a1,33
  80063e:	00000517          	auipc	a0,0x0
  800642:	41a50513          	addi	a0,a0,1050 # 800a58 <error_string+0x150>
  800646:	9dbff0ef          	jal	ra,800020 <__panic>
        cprintf("I am the child.\n");
  80064a:	00000517          	auipc	a0,0x0
  80064e:	3ae50513          	addi	a0,a0,942 # 8009f8 <error_string+0xf0>
  800652:	ac9ff0ef          	jal	ra,80011a <cprintf>
        yield(); 
  ...
  80066a:	a6fff0ef          	jal	ra,8000d8 <yield>
        yield();
  80066e:	a6bff0ef          	jal	ra,8000d8 <yield>
        exit(magic);
  800672:	00001517          	auipc	a0,0x1
  800676:	98e52503          	lw	a0,-1650(a0) # 801000 <magic>
  80067a:	a3fff0ef          	jal	ra,8000b8 <exit>
