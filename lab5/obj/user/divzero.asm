...
__panic(const char *file, int line, const char *fmt, ...) { // 定义__panic函数，接受文件名、行号和格式化字符串作为参数
  ...
  800034:	55050513          	addi	a0,a0,1360 # 800580 <main+0x36>
__panic(const char *file, int line, const char *fmt, ...) { // 定义__panic函数，接受文件名、行号和格式化字符串作为参数
  ...
  800054:	55050513          	addi	a0,a0,1360 # 8005a0 <main+0x56>
...
exit(int error_code) { // 定义exit函数，参数为错误代码
  ...
  8000b4:	4f850513          	addi	a0,a0,1272 # 8005a8 <main+0x5e>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80019a:	42a78793          	addi	a5,a5,1066 # 8005c0 <main+0x76>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f6:	402a8a93          	addi	s5,s5,1026 # 8005f4 <main+0xaa>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001fe:	616b8b93          	addi	s7,s7,1558 # 800810 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800454:	1a060613          	addi	a2,a2,416 # 8005f0 <main+0xa6>
  ...
  800466:	17e60613          	addi	a2,a2,382 # 8005e0 <main+0x96>
  ...
  800478:	16440413          	addi	s0,s0,356 # 8005d8 <main+0x8e>
  ...
  800502:	0da40413          	addi	s0,s0,218 # 8005d8 <main+0x8e>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800518:	0c5a0a13          	addi	s4,s4,197 # 8005d9 <main+0x8f>
...
main(void) {
    cprintf("value is %d.\n", 1 / zero);
  80054a:	00001797          	auipc	a5,0x1
  80054e:	ab67a783          	lw	a5,-1354(a5) # 801000 <zero>
  800552:	4585                	li	a1,1
  800554:	02f5c5bb          	divw	a1,a1,a5
main(void) {
  800558:	1141                	addi	sp,sp,-16
    cprintf("value is %d.\n", 1 / zero);
  80055a:	00000517          	auipc	a0,0x0
  80055e:	37e50513          	addi	a0,a0,894 # 8008d8 <error_string+0xc8>
main(void) {
  800562:	e406                	sd	ra,8(sp)
    cprintf("value is %d.\n", 1 / zero);
  800564:	b9bff0ef          	jal	ra,8000fe <cprintf>
    panic("FAIL: T.T\n");
  800568:	00000617          	auipc	a2,0x0
  80056c:	38060613          	addi	a2,a2,896 # 8008e8 <error_string+0xd8>
  800570:	45a5                	li	a1,9
  800572:	00000517          	auipc	a0,0x0
  800576:	38650513          	addi	a0,a0,902 # 8008f8 <error_string+0xe8>
  80057a:	aa7ff0ef          	jal	ra,800020 <__panic>
