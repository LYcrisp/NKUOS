...
exit(int error_code) { // 定义exit函数，参数为错误代码
  ...
  800072:	48a50513          	addi	a0,a0,1162 # 8004f8 <main+0x10>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800138:	3dc78793          	addi	a5,a5,988 # 800510 <main+0x28>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  800194:	3b4a8a93          	addi	s5,s5,948 # 800544 <main+0x5c>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  80019c:	5c8b8b93          	addi	s7,s7,1480 # 800760 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003f2:	15260613          	addi	a2,a2,338 # 800540 <main+0x58>
  ...
  800404:	13060613          	addi	a2,a2,304 # 800530 <main+0x48>
  ...
  800416:	11640413          	addi	s0,s0,278 # 800528 <main+0x40>
  ...
  8004a0:	08c40413          	addi	s0,s0,140 # 800528 <main+0x40>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004b6:	077a0a13          	addi	s4,s4,119 # 800529 <main+0x41>
...
main(void) {
  8004ec:	e406                	sd	ra,8(sp)
    exit(0);
  8004ee:	b79ff0ef          	jal	ra,800066 <exit>
