...
__panic(const char *file, int line, const char *fmt, ...) { // 定义__panic函数，接受文件名、行号和格式化字符串作为参数
  ...
  800034:	54850513          	addi	a0,a0,1352 # 800578 <main+0x2e>
__panic(const char *file, int line, const char *fmt, ...) { // 定义__panic函数，接受文件名、行号和格式化字符串作为参数
  ...
  800054:	54850513          	addi	a0,a0,1352 # 800598 <main+0x4e>
...
exit(int error_code) { // 定义exit函数，参数为错误代码
  ...
  8000b4:	4f050513          	addi	a0,a0,1264 # 8005a0 <main+0x56>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80019a:	42278793          	addi	a5,a5,1058 # 8005b8 <main+0x6e>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f6:	3faa8a93          	addi	s5,s5,1018 # 8005ec <main+0xa2>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001fe:	60eb8b93          	addi	s7,s7,1550 # 800808 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800454:	19860613          	addi	a2,a2,408 # 8005e8 <main+0x9e>
  ...
  800466:	17660613          	addi	a2,a2,374 # 8005d8 <main+0x8e>
  ...
  800478:	15c40413          	addi	s0,s0,348 # 8005d0 <main+0x86>
  ...
  800502:	0d240413          	addi	s0,s0,210 # 8005d0 <main+0x86>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800518:	0bda0a13          	addi	s4,s4,189 # 8005d1 <main+0x87>
...
main(void) {
  ...
  80054a:	3eb00793          	li	a5,1003
  80054e:	07da                	slli	a5,a5,0x16
  800550:	438c                	lw	a1,0(a5)
main(void) {
  800552:	1141                	addi	sp,sp,-16
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  800554:	00000517          	auipc	a0,0x0
  800558:	37c50513          	addi	a0,a0,892 # 8008d0 <error_string+0xc8>
main(void) {
  80055c:	e406                	sd	ra,8(sp)
    cprintf("I read %08x from 0xfac00000!\n", *(unsigned *)0xfac00000);
  80055e:	ba1ff0ef          	jal	ra,8000fe <cprintf>
    panic("FAIL: T.T\n");
  800562:	00000617          	auipc	a2,0x0
  800566:	38e60613          	addi	a2,a2,910 # 8008f0 <error_string+0xe8>
  80056a:	459d                	li	a1,7
  80056c:	00000517          	auipc	a0,0x0
  800570:	39450513          	addi	a0,a0,916 # 800900 <error_string+0xf8>
