...
__panic(const char *file, int line, const char *fmt, ...) { // 定义__panic函数，接受文件名、行号和格式化字符串作为参数
  ...
  800034:	5c850513          	addi	a0,a0,1480 # 8005f8 <main+0xae>
__panic(const char *file, int line, const char *fmt, ...) { // 定义__panic函数，接受文件名、行号和格式化字符串作为参数
  ...
  800054:	5c850513          	addi	a0,a0,1480 # 800618 <main+0xce>
...
exit(int error_code) { // 定义exit函数，参数为错误代码
  ...
  8000b4:	57050513          	addi	a0,a0,1392 # 800620 <main+0xd6>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  80019a:	4a278793          	addi	a5,a5,1186 # 800638 <main+0xee>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001f6:	47aa8a93          	addi	s5,s5,1146 # 80066c <main+0x122>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001fe:	68eb8b93          	addi	s7,s7,1678 # 800888 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  800454:	21860613          	addi	a2,a2,536 # 800668 <main+0x11e>
  ...
  800466:	1f660613          	addi	a2,a2,502 # 800658 <main+0x10e>
  ...
  800478:	1dc40413          	addi	s0,s0,476 # 800650 <main+0x106>
  ...
  800502:	15240413          	addi	s0,s0,338 # 800650 <main+0x106>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  800518:	13da0a13          	addi	s4,s4,317 # 800651 <main+0x107>
...
main(void) {
  800554:	e406                	sd	ra,8(sp)
    cprintf("Making sure bss works right...\n");
  800556:	ba9ff0ef          	jal	ra,8000fe <cprintf>
    int i;
  ...
  80058a:	a97ff0ef          	jal	ra,800020 <__panic>
  ...
  8005f0:	a007aa23          	sw	zero,-1516(a5) # c02000 <bigarray+0x401000>
    exit(0);
  8005f4:	ab5ff0ef          	jal	ra,8000a8 <exit>
