...
exit(int error_code) { // 定义exit函数，参数为错误代码
  ...
  80007a:	4b250513          	addi	a0,a0,1202 # 800528 <main+0x34>
...
printnum(void (*putch)(int, void*), void *putdat,
  ...
  800144:	40078793          	addi	a5,a5,1024 # 800540 <main+0x4c>
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap) {
  ...
  8001a0:	3d8a8a93          	addi	s5,s5,984 # 800574 <main+0x80>
        case 'e':
            err = va_arg(ap, int);
            if (err < 0) {
                err = -err;
  ...
  8001a8:	5ecb8b93          	addi	s7,s7,1516 # 800790 <error_string>
        while ((ch = *(unsigned char *)fmt ++) != '%') {
  ...
  8003fe:	17660613          	addi	a2,a2,374 # 800570 <main+0x7c>
  ...
  800410:	15460613          	addi	a2,a2,340 # 800560 <main+0x6c>
  ...
  800422:	13a40413          	addi	s0,s0,314 # 800558 <main+0x64>
  ...
  8004ac:	0b040413          	addi	s0,s0,176 # 800558 <main+0x64>
            for (; (ch = *p ++) != '\0' && (precision < 0 || -- precision >= 0); width --) {
  ...
  8004c2:	09ba0a13          	addi	s4,s4,155 # 800559 <main+0x65>
...
main(void) {
  ...
  8004f8:	b8dff0ef          	jal	ra,800084 <getpid>
  8004fc:	85aa                	mv	a1,a0
  8004fe:	00000517          	auipc	a0,0x0
  800502:	35a50513          	addi	a0,a0,858 # 800858 <error_string+0xc8>
  800506:	ba3ff0ef          	jal	ra,8000a8 <cprintf>
    print_pgdir();
  80050a:	b7dff0ef          	jal	ra,800086 <print_pgdir>
    cprintf("pgdir pass.\n");
  80050e:	00000517          	auipc	a0,0x0
  800512:	36250513          	addi	a0,a0,866 # 800870 <error_string+0xe0>
  800516:	b93ff0ef          	jal	ra,8000a8 <cprintf>
    return 0;
}
