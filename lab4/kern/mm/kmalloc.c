...
/**
 * __slob_get_free_pages - 分配多个连续的物理页
 * @gfp: 分配标志
 * @order: 页的数量，以2的幂次表示
 *
 * 返回分配的页的虚拟地址，如果分配失败则返回NULL
 */
...
/**
 * slob_allocated - 返回已分配的内存大小
 *
 * 返回已分配的内存大小，当前实现总是返回0
 */
